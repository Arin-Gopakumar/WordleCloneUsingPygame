...
pygame.display.set_caption("Wordle With Definitions")
...
#NEW----------
dict = PyDictionary()
meaning = dict.meaning(CORRECT_WORD)
print(meaning)
#NEW----------
...
def play_again():
    ...
    #dictionary_font = pygame.font.Font("assets/FreeSansBold.otf", 25)
    #dictionary_text = dictionary_font.render(f"The Definition of the word above is: " + str(Dictionary()), True, "black")
    #dictionary_rect = dictionary_text.get_rect(center=(WIDTH / 2, 800))

    SCREEN.blit(word_was_text, word_was_rect)
    SCREEN.blit(play_again_text, play_again_rect)
   #SCREEN.blit(dictionary_text, dictionary_rect)
